...
static String htmlIndex() {
    ...
    h += F(
        ...
        "<tr><td class='k' id='t_ipv6'>IPv6</td><td class='v mono' id='ipv6'></td></tr>"
...
static void httpStatus() {
    ...
    json += "\"ipv6_link_local\":\"" + jsonEscape(ipv6Link) + "\",";
    json += "\"ipv6_global\":\"" + jsonEscape(ipv6Global) + "\",";
