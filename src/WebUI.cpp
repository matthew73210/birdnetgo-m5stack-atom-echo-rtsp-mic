...
static String htmlIndex() {
    ...
    h += F(
        ...
        "<title>Atom Echo - RTSP Microphone</title>"
        ...
        "<div class='page'>"
        "<div class='card'><div class='hero'><div><div class='brand'><div class='title' id='t_title'>Atom Echo</div><span class='badge' id='fwv'></span></div><div class='subtitle'>URL: <a id='rtsp' class='mono' href='rtsp://");
    h += ip;
    h += F(
...
static void httpAudioStatus() {
    ...
    String i2sHint;
    if (likelyFlatline) {
        i2sHint = "Mic data looks flat/near-zero. On Atom Echo check the built-in mic path first; MIC CLK is G33 and MIC DATA is G23.";
